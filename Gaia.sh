...
echo -e "Название кошелька: \e[1m\e[32m$WALLET\e[0m"
echo -e "Название сети: \e[1m\e[32m$GAIA_CHAIN_ID\e[0m"
echo -e "Ваш порт: \e[1m\e[32m$GAIA_PORT\e[0m"
echo '================================================='
sleep 2

echo -e "\e[1m\e[32m1. Обновление пакетов... \e[0m" && sleep 1
# update
sudo apt update && sudo apt upgrade -y

echo -e "\e[1m\e[32m2. Установка зависимостей... \e[0m" && sleep 1
# packages
...
echo -e "\e[1m\e[32m3. Скачивание и сборка бинарников... \e[0m" && sleep 1
# download binary
cd $HOME
...
echo -e "\e[1m\e[32m4. Запуск службы... \e[0m" && sleep 1
# create service
...
echo -e 'Проверка логов: \e[1m\e[32mjournalctl -u gaiad -f -o cat\e[0m'
echo -e "Проверка статуса: \e[1m\e[32mcurl -s localhost:${GAIA_PORT}657/status | jq .result.sync_info\e[0m"
